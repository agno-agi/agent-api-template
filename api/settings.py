...
class ApiSettings(BaseSettings):
    ...
    def set_cors_origin_list(cls, cors_origin_list, info: FieldValidationInfo):
        ...
        # Add agno.com to cors origin list to allow requests from the Agno playground.
        valid_cors.extend(["https://agno.com", "https://www.agno.com"])

        runtime_env = info.data.get("runtime_env")
        # If runtime_env is dev, add localhost to cors origin list.
        if runtime_env == "dev":
            valid_cors.extend(["http://localhost"])
